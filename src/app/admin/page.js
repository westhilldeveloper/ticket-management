...
function AdminDashboardContent() {
  ...
  const generateChartData = () => {
    ...
    const categoryData = {
      ...
      datasets: [{
        data: [
          stats.ticketsByCategory?.HR || 0,
          stats.ticketsByCategory?.IT || 0,
          stats.ticketsByCategory?.TECHNICAL || 0
        ],
        backgroundColor: [CHART_COLORS.primary, CHART_COLORS.secondary, CHART_COLORS.warning]
      }]
    }
    ...
    const priorityData = {
      ...
      datasets: [{
        ...
        backgroundColor: [CHART_COLORS.primary, CHART_COLORS.secondary, CHART_COLORS.warning, CHART_COLORS.danger]
      }]
    }
    ...
    // Trend data (simplified - you'd get this from API)
